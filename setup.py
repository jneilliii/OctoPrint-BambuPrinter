...
# Additional package data to install for this plugin. Since you have only a Python file, no templates or static files are needed
...
# define dependency links or other things like that, this is the place to go. Will be merged recursively with
# the default setup parameters as provided by octoprint_setuptools.create_plugin_setup_parameters using
...
additional_setup_parameters = {
    ...
    "entry_points": {
        "octoprint.plugin": [
            "bambu_printer = octoprint_bambu_printer.bambu_printer:BambuPrinterPlugin",  # Entry point for the plugin class
        ],
    }
}
